...
theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  ...
  scale_x_continuous(breaks = c(1,2), labels = labelvec, limits = c(0.55, 4.45)) +
  ylab("") +
  xlab("")

#quantvis
ggsave(here("miscellaneous", "presentation", "make_figures", "progressionplots_quantileextraction", "illustration_quantileextraction_2.pdf"), quantvis, width = 8, height = 3.75)
