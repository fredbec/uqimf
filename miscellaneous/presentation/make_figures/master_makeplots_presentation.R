...
source(here("manuscript_plots", "presentation_coverage_plots.R"))
...
for(m in 1:nrow(all_plotcombs)){
  ...
  ggplot2::ggsave(here(paste0(global_file_prefix, "ext_wis_", chosen_target, dataset_suffix, ".pdf")),
                  wis_plot, width = 11, height = 7)
  ggplot2::ggsave(here(paste0(global_file_prefix, "coverage_", chosen_target,dataset_suffix,".pdf")),
                  cvg_plot, width = 5.2, height = 4)
