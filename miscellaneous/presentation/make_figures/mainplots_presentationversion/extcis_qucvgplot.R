...
ciscores1 <- rbind(ciscores2[model != "IMF"], ciscores1) |>
  .d(model %in% c("Direct: AR", "Direct: BVAR", "Direct: BVAR-Mix", "BVAR", "AR", "IMF", "nominal"))
...
ggsave(here("extcis_devqucvgplot.pdf"), width = 8.3, height = 5)
