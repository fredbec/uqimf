...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#bring into long format}
\NormalTok{long\_scores }\OtherTok{\textless{}{-}} \FunctionTok{gather\_scores}\NormalTok{(all\_scores, }\StringTok{"pcpi\_pch"}\NormalTok{)}

\FunctionTok{scores\_to\_table}\NormalTok{(all\_scores, }\StringTok{"pcpi\_pch"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{manuscript_files/figure-latex/overall_assessment-1.pdf}
