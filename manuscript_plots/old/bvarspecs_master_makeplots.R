...
for(m in 1:nrow(all_plotcombs)){
  ...
  ggplot2::ggsave(here("..", "uqimf-manuscript", "figures", paste0(global_file_prefix, prefix, "wis_", chosen_target, dataset_suffix, ".pdf")),
                  wis_plot, width = 9, height = 8)
  ggplot2::ggsave(here("..", "uqimf-manuscript", "figures", paste0(global_file_prefix, prefix, "coverage_", chosen_target, dataset_suffix, ".pdf")),
...
if(FALSE){
  #these aren't used in the current version of the manuscript
