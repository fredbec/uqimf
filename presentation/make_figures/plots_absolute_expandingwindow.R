...
pdf(file = here("presentation", "figures", "wis_cpigdp_expandingwindow.pdf"), width = 9.5, height = 4)
ovr_plot <-
  (cpi_plot | gdp_plot) +
...
pdf(file = here("presentation", "figures", "coverage_expandingwindow.pdf"), width = 9.5, height = 4)
ovr_plot <-
  (plot_cpi | plot_gdp) +
  plot_layout(guides = "collect",
              heights = c(1)) &
